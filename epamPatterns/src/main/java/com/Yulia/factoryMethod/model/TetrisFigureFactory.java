...
public class TetrisFigureFactory {
    ...
    public void buildingParts(){
        System.out.println("Building part: " + block1);
        System.out.println("Building part: " + block2);
        System.out.println("Building part: " + block3);
        System.out.println("Building part: " + block4);
    }
